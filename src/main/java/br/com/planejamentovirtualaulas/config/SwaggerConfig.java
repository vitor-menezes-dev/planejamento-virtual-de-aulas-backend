package br.com.planejamentovirtualaulas.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.planejamentovirtualaulas.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Planejamento Virtual de Aulas",
				"Esta API é utilizada na aplicação de Planejamento Virtual de Aulas", "Versão 1.0", null,
				new Contact("Vitor Andrade Menezes de Sousa", null, "vitor.menezes.dev@gmail.com"), null, null,
